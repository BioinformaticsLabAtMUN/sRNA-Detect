...
To run sRNA-Detect, the [HTSeq  python library](http://www-huber.embl.de/users/anders/HTSeq/doc/index.html) (version 0.5.4p5) and Python 2.7 need to be installed. 
